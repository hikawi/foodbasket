...
> These requirements may be out of date as the backend is in the process of being
> migrated to Rust, because why not.
...
- Go Test Sum (for viewing beautiful output from testing)
- Gocovsh (for viewing coverage report from testing)
