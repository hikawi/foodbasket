...
CREATE TABLE "public"."assignments" (
  ...
  CONSTRAINT "assignments_staff_profile_id_fkey" FOREIGN KEY ("staff_profile_id") REFERENCES "public"."staff_profiles" ("id") ON UPDATE NO ACTION ON DELETE NO ACTION
);
-- Create index "uidx_assignments_staff_profile_id_policy_id_scope_id" to table: "assignments"
CREATE UNIQUE INDEX "uidx_assignments_staff_profile_id_policy_id_scope_id" ON "public"."assignments" ("staff_profile_id", "policy_id", "scope_id");
